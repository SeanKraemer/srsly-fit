...
import { getDashboardData } from "@/src/data/fitnessData";
...
export default async function DashBoard() {
    ...
    const { workoutTemplates, totalExercisesCompleted } = await getDashboardData(userId);
    ...
    return (
        <main className='w-full h-fit flex-wrap bg-orange-700 rounded'>
            ...
            <div className="text-center pb-4 text-white">
                <h3 className="font-bold text-xl">Exercise Completion History</h3>
                <p className="text-sm text-orange-100">Total completed exercise entries recorded in your workout log.</p>
